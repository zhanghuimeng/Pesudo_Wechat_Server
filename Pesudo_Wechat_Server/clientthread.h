...
signals:
    ...
    void signal_receive_file();  // emit to mainthread
...
public slots:
    ...
    void slot_send_message_text(QDateTime time, QString sender, QString receiver, QString text);  // received from serverthread
    void slot_send_message_file();  // TODO
